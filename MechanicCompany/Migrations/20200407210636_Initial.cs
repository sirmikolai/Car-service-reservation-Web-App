        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstName = table.Column<string>(nullable: true),
                    LastName = table.Column<string>(nullable: true),
                    RoleInCompany = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RepairRecords_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RepairRecords_Mechanics_MechanicId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairRecords_CarId",
                table: "RepairRecords",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_RepairRecords_MechanicId",
                table: "RepairRecords",
                column: "MechanicId");
        }
